...
### [Apple Tests Siri Feature That Handles Multiple Commands at Once](https://links.tldrnewsletter.com/Db0bgV)
...
### [Microbubbles](https://www.worksinprogress.news/p/the-cruise-missiles-of-medicine)
...
### [Quantum computers need vastly fewer resources than thought to break vital encryption](https://arstechnica.com/security/2026/03/new-quantum-computing-advances-heighten-threat-to-elliptic-curve-cryptosystems)
...
### [Inside the Claude Code source](https://links.tldrnewsletter.com/sCHaFt)
...
### [Project Mario](https://colossus.com/article/project-mario-demis-hassabis-deepmind-mallaby)
...
### [Meet the Startup That Used AI and OpenClaw to Automate Its Own Developers](https://links.tldrnewsletter.com/6c5pry)
...
### [Oracle Lays Off Workers Amid Heavy AI Investment](https://links.tldrnewsletter.com/3XtTUn)
...
### [You can finally change the goofy Gmail address you chose years ago](https://arstechnica.com/gadgets/2026/03/you-can-finally-change-the-goofy-gmail-address-you-chose-years-ago)

Gmail users can now create new account names without losing access to their old addresses.

### [Google Readies Screenless Fitbit Band to Rival Growing Whoop Craze](https://links.tldrnewsletter.com/2ZZeCw)

The band will integrate with an AI-powered personal health coach inside the newly redesigned Fitbit app.

### [OpenAI Closes Silicon Valley's Largest-Ever Funding Round](https://links.tldrnewsletter.com/A1EwKi)
