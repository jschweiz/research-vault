...
ingested_at: '2026-04-09T12:05:03.989665Z'
content_hash: 88e11840acab771a409d77d34823ee6317938bada5837d2268dc8e8e38d5f895
identity_hash: 256722284c86a17621ac2d10409df55592e7e630f7da67ac691f2b4a428865ef
tags:
- newsletter
- tldr
- email
...
fetched_at: '2026-04-09T12:15:29.787644Z'
...
lightweight_enriched_at: '2026-04-09T14:23:57.126236Z'
...
lightweight_score:
  ...
  evidence_quotes:
  - TLDR roundup on Apple eGPU support, inside AI lab finances, Claude Code system prompts. Includes 8 editorial stories across 4 sections, plus 5 quick links.
---
# Apple eGPU support ⚡, inside AI lab finances 💰, Claude Code system prompts 🤖

## Big Tech & Startups

### [An Inside Look at OpenAI and Anthropic's Finances Ahead of Their IPOs](https://links.tldrnewsletter.com/twN9vX)
...
### [Apple approves drivers that let AMD and Nvidia eGPUs run on Mac — software designed for AI, though, and not built for gaming](https://www.tomshardware.com/pc-components/gpu-drivers/apple-approves-drivers-that-let-amd-and-nvidia-egpus-run-on-mac-software-designed-for-ai-though-and-not-built-for-gaming)
...
### [Impulse Space, Anduril Building Space Technology for Golden Dome](https://links.tldrnewsletter.com/2oeeq0)
...
### [China's Tech Giants Are Recruiting High Schoolers](https://www.sixthtone.com/news/1018378)
...
### [Economists Once Dismissed the AI Job Threat, but Not Anymore](https://links.tldrnewsletter.com/wTymFv)
...
### [Non-Determinism Isn't a Bug. It's Tuesday: Why Product Managers Were Built for AI (They Just Don't Know It Yet)](https://www.kasava.dev/blog/why-pms-are-built-for-ai)

The gap between 'using AI' and 'getting real value from AI' is fundamentally a product problem.

### [OpenAI COO Shifts Out of Role, AGI CEO Taking Medical Leave](https://links.tldrnewsletter.com/KbKYaI)

Brad Lightcap, OpenAI's longtime COO, will now lead special projects and report directly to CEO Sam Altman.

### [GitHub activity is surging](https://threadreaderapp.com/thread/2040164759836778878.html)

GitHub is on pace for 14 billion commits in a year, if growth remains linear.

### [1 in 30 – Artemis, Greatness, and Risk.](https://1517.substack.com/p/1-in-30-artemis-greatness-and-risk)
