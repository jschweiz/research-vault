...
- topic:apple
- topic:egpu
updated_at: '2026-04-09T12:15:42.302676Z'
managed: true
---
# Mac
...
- [Apple approves drivers that let AMD and Nvidia eGPUs run on Mac — software designed for AI, though, and not built for gaming](../sources/apple-approves-drivers-that-let-amd-and-nvidia-egpus-run-on-mac--1b4ca9.md)
